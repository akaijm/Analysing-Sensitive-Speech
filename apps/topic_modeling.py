...
def update_model_desc(preselect_gsdmm):
    ...
    return [output, html.Br(), html.Br(), html.I(className="fas fa-database", style={"paddingRight": "5px"}), "Note that text duplicates were removed and comments that were created before their source posts were created (due to data collection errors) were included."]
